...
This paper presents \textit{SYNSheild}: an end-to-end deep learning pipeline
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \draw[arr] (model) -- (eval);
  \end{tikzpicture}
  \caption{End-to-end \textit{SYNSheild} pipeline: raw network captures to
...
\begin{itemize}
  ...
  \item The SYN-count labeling heuristic may mislabel PCAPs containing
        connection-heavy benign services.
...
We presented \textit{SYNSheild}, an end-to-end deep learning pipeline for
